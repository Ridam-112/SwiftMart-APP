...
export default function RiderTabLayout() {
  ...
  return (
    ...
    >
      <Tabs.Screen name="dashboard"   options={{ title: 'Dashboard',   tabBarIcon: ({ color, focused }) => <Ionicons name={focused ? 'bicycle' : 'bicycle-outline'} size={24} color={color} /> }} />
      <Tabs.Screen name="deliveries"  options={{ title: 'Deliveries',  tabBarIcon: ({ color, focused }) => <Ionicons name={focused ? 'bag' : 'bag-outline'} size={24} color={color} /> }} />
