...
// of origins and returns errors for any other browser Origin — including
// this workspace's preview domain. The Expo web build therefore routes
// requests through this proxy (server-to-server, no Origin header) instead
// of calling swiftmart.space directly. See swiftmart-mobile/lib/api.ts.
